...
@Config
public final class FrontStageRedRightPath extends AutoPath {
    public static double pushX = initX + 2.5;
    public static double pushY = initY + 25;
    public static double pushAngle = initAngle - 40;
    public static double invPushAngle = AutoPath.reverseAngle(pushAngle - 10);
    ...
    public FrontStageRedRightPath(OpMode newOpMode, PhaseTwoBot newBot, MecanumDrive newDrive) {
        super(StartingPosition.FRONT_RED, newOpMode, newBot, newDrive);
    }
