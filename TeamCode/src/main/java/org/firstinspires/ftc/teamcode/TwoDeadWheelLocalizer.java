...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1936.1316199743837; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -271.3833112567085; // x position of the perpendicular encoder (in tick units)
    }
