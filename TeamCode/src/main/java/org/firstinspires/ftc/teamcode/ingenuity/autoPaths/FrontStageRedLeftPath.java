...
@Config
public final class FrontStageRedLeftPath extends AutoPath {
    ...
    public FrontStageRedLeftPath(OpMode newOpMode, PhaseTwoBot newBot, MecanumDrive newDrive) {
    ...
    public void runAutoPath() {
        Actions.runBlocking(drive.actionBuilder(drive.pose)
                ...
                .splineTo(new Vector2d(-49, -49), Math.toRadians(180), mediumSpeed)
