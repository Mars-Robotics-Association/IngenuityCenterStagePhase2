...
public final class MecanumDrive {
    public static class Params {
        ...
        public double trackWidthTicks = 3901.033114469231;

        // feedforward parameters (in tick units)
        public double kS = 0.97;     // 0.9998675
        public double kV = 0.00057;      //0.000582842113;
        public double kA = 0.0001;

        // path profile parameters (in inches)
        public double maxWheelVel = 50;  // Default = 50
        public double minProfileAccel = -15;
        public double maxProfileAccel = 20;  // Default = 30

        // turn profile parameters (in radians)
        public double maxAngVel = Math.PI * 0.9; // shared with path
        public double maxAngAccel = Math.PI * 0.7;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "leftFront"); // port 1
        leftBack = hardwareMap.get(DcMotorEx.class, "leftBack"); // port 3
        rightBack = hardwareMap.get(DcMotorEx.class, "rightBack"); // port 2
        rightFront = hardwareMap.get(DcMotorEx.class, "rightFront"); // port 0
