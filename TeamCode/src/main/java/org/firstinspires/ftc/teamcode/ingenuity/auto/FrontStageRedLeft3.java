...
@Config
@Autonomous(name = "left 3 front stage red", group = "Auto 3.0 development")
public final class FrontStageRedLeft3 extends LinearOpMode {
    ...
    public static double pushX = initX - 7;
